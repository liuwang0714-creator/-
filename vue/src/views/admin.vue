  ...
  <div class="admin-page">
    ...
    <header class="top-header">
      <div class="header-left">
        ...
        <h1 class="page-title">瞻途管理员控制台</h1>
        <RouterLink to="/admindp" class="link-btn" exact-active-class="active">
    ...
    <div class="main-layout">
      <nav class="sidebar">
        ...
        <RouterLink to="/admin/adminhome" class="link-btn" exact-active-class="active">
          <el-icon :size="16"><User /></el-icon>
          <span>个人中心</span>
        </RouterLink>
        <RouterLink to="/admin/adminuserlist" class="link-btn" exact-active-class="active">
          <el-icon :size="16"><List /></el-icon>
          <span>用户列表</span>
        </RouterLink>
        <RouterLink to="/admin/admingoods" class="link-btn" exact-active-class="active">
          <el-icon :size="16"><Goods /></el-icon>
          <span>商品管理</span>
        </RouterLink>
        <RouterLink to="/admin/adminorder" class="link-btn" exact-active-class="active">
          <el-icon :size="16"><Document /></el-icon>
          <span>订单管理</span>
        </RouterLink>
        <RouterLink to="/admin/chat" class="link-btn" exact-active-class="active">
...
import { Setting, User, List, Goods, Document, ChatDotRound } from '@element-plus/icons-vue'

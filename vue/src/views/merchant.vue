  ...
  <div class="admin-page">
    ...
    <header class="top-header">
      <div class="header-left">
        ...
        <h1 class="page-title">瞻途商户控制台</h1>
      </div>
    ...
    <div class="main-layout">
      <nav class="sidebar">
        ...
        <RouterLink to="/merchant/merchanthome" class="link-btn">
          <el-icon :size="16"><Shop /></el-icon>
          <span>首页</span>
        </RouterLink>
        <RouterLink to="/merchant/merchantgoods" class="link-btn">
          <el-icon :size="16"><Goods /></el-icon>
          <span>商品管理</span>
        </RouterLink>
        <RouterLink to="/merchant/merchantorder" class="link-btn">
          <el-icon :size="16"><Document /></el-icon>
          <span>订单管理</span>
        </RouterLink>
        <RouterLink to="/merchant/chat" class="link-btn">
...
import { Shop, Goods, Document, ChatDotRound } from '@element-plus/icons-vue'
